...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn.GlobalScriptTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GlobalScriptTaskItemProvider extends GlobalTaskItemProvider
    ...
    protected void addScriptLanguagePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ...
                        getResourceLocator(),
                        getString("_UI_GlobalScriptTask_scriptLanguage_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_GlobalScriptTask_scriptLanguage_feature", "_UI_GlobalScriptTask_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        bpmnPackage.eINSTANCE
                                .getGlobalScriptTask_ScriptLanguage(), true,
                        false, false,
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_GlobalScriptTask_type") : //$NON-NLS-1$
                getString("_UI_GlobalScriptTask_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
