...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn.DataAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataAssociationItemProvider extends BaseElementItemProvider
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_DataAssociation_type") : //$NON-NLS-1$
                getString("_UI_DataAssociation_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(BpmnPackage.eINSTANCE
                .getDataAssociation_Assignment(), BpmnFactory.eINSTANCE
                .createAssignment()));
    }
