...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn.ResourceAssignmentExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceAssignmentExpressionItemProvider extends
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(bpmnPackage.eINSTANCE
                    .getResourceAssignmentExpression_ExpressionGroup());
        }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ResourceAssignmentExpression_type") : //$NON-NLS-1$
                getString("_UI_ResourceAssignmentExpression_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
