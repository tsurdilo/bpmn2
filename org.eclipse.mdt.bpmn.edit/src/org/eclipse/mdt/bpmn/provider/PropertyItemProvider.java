...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyItemProvider extends BaseElementItemProvider implements
    ...
    protected void addItemSubjectRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ...
                        getResourceLocator(),
                        getString("_UI_Property_itemSubjectRef_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_Property_itemSubjectRef_feature", "_UI_Property_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        BpmnPackage.eINSTANCE.getProperty_ItemSubjectRef(),
                        true, false, false,
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ...
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_Property_name_feature", "_UI_Property_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        BpmnPackage.eINSTANCE.getProperty_Name(), true, false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(BpmnPackage.eINSTANCE.getProperty_DataState());
        }
