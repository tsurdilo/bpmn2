...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn.ParticipantMultiplicity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParticipantMultiplicityItemProvider extends
    ...
    protected void addMaximumPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ...
                        getResourceLocator(),
                        getString("_UI_ParticipantMultiplicity_maximum_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_ParticipantMultiplicity_maximum_feature", "_UI_ParticipantMultiplicity_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        BpmnPackage.eINSTANCE
                                .getParticipantMultiplicity_Maximum(), true,
                        false, false,
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ((ComposeableAdapterFactory) adapterFactory)
                                .getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_ParticipantMultiplicity_minimum_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_ParticipantMultiplicity_minimum_feature", "_UI_ParticipantMultiplicity_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        BpmnPackage.eINSTANCE
                                .getParticipantMultiplicity_Minimum(), true,
                        false, false,
                        ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ParticipantMultiplicity_type") : //$NON-NLS-1$
                getString("_UI_ParticipantMultiplicity_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
