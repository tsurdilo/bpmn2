...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn.ResourceParameterBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceParameterBindingItemProvider extends
    ...
    protected void addParameterRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ...
                        getResourceLocator(),
                        getString("_UI_ResourceParameterBinding_parameterRef_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_ResourceParameterBinding_parameterRef_feature", "_UI_ResourceParameterBinding_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(BpmnPackage.eINSTANCE
                    .getResourceParameterBinding_ExpressionGroup());
        }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ResourceParameterBinding_type") : //$NON-NLS-1$
                getString("_UI_ResourceParameterBinding_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(BpmnPackage.eINSTANCE
                .getResourceParameterBinding_ExpressionGroup(), FeatureMapUtil
