...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn.ErrorEventDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ErrorEventDefinitionItemProvider extends
    ...
    protected void addErrorCodePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ...
                        getResourceLocator(),
                        getString("_UI_ErrorEventDefinition_errorCode_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_ErrorEventDefinition_errorCode_feature", "_UI_ErrorEventDefinition_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        bpmnPackage.eINSTANCE
                                .getErrorEventDefinition_ErrorCode(), true,
                        false, false,
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ((ComposeableAdapterFactory) adapterFactory)
                                .getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_ErrorEventDefinition_errorRef_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_ErrorEventDefinition_errorRef_feature", "_UI_ErrorEventDefinition_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        bpmnPackage.eINSTANCE
                                .getErrorEventDefinition_ErrorRef(), true,
                        false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This returns ErrorEventDefinition.png.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ErrorEventDefinition_type") : //$NON-NLS-1$
                getString("_UI_ErrorEventDefinition_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
