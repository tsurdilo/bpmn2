...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn.SubConversation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubConversationItemProvider extends ConversationNodeItemProvider
    ...
    protected void addCorrelationKeyRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ...
                        getResourceLocator(),
                        getString("_UI_SubConversation_correlationKeyRef_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_SubConversation_correlationKeyRef_feature", "_UI_SubConversation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        bpmnPackage.eINSTANCE
                                .getSubConversation_CorrelationKeyRef(), true,
                        false, false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(bpmnPackage.eINSTANCE
                    .getSubConversation_ArtifactGroup());
        }
    ...
    /**
     * This returns SubConversation.png.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_SubConversation_type") : //$NON-NLS-1$
                getString("_UI_SubConversation_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(bpmnPackage.eINSTANCE
                ...
                .createEntry(bpmnPackage.eINSTANCE
                        .getSubConversation_ConversationNode(),
