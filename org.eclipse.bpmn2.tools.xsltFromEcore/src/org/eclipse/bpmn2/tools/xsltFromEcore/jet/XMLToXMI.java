 ...
 */
 ...
 public class XMLToXMI
 {
  ...
  protected final String TEXT_22 = "Template\" />\t\t\t   " + NL + "\t\t\t</";
  protected final String TEXT_23 = ">" + NL + "          </xsl:when >";
  protected final String TEXT_24 = NL + "        </xsl:choose>";
  protected final String TEXT_25 = NL + "        <";
  protected final String TEXT_26 = " xmi:type=\"";
  protected final String TEXT_27 = "xmi:";
  protected final String TEXT_28 = "\">\t\t\t    " + NL + "           <xsl:call-template name=\"";
  protected final String TEXT_29 = "Template\" />\t\t\t   " + NL + "        </";
  protected final String TEXT_30 = ">";
  protected final String TEXT_31 = NL + "      </xsl:for-each>";
  protected final String TEXT_32 = NL + "\t</xsl:template>" + NL + "  ";
  protected final String TEXT_33 = NL + "</xsl:stylesheet>";
