 ...
 */
 ...
 public class XMLToXMI
 {
  ...
  protected final String TEXT_15 = "Template\">" + NL + "\t  <xsl:call-template name=\"";
  ...
  protected final String TEXT_19 = NL + "      <xsl:for-each select=\"";
  protected final String TEXT_20 = "\">";
  protected final String TEXT_21 = NL + "        <xsl:choose>\t\t";
  protected final String TEXT_22 = " " + NL + "          <xsl:when test=\"self::";
  protected final String TEXT_23 = "\">" + NL + "            <";
  protected final String TEXT_24 = " xmi:type=\"";
  protected final String TEXT_25 = "xmi:";
  protected final String TEXT_26 = "\">\t\t\t    " + NL + "\t\t\t  <xsl:call-template name=\"";
  ...
  protected final String TEXT_37 = NL + "\t</xsl:template>" + NL + "  ";
  protected final String TEXT_38 = NL + "</xsl:stylesheet>";
