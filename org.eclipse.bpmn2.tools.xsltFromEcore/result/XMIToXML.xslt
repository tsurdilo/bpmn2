...
<xsl:stylesheet version="2.0"
	...
	<xsl:template name="BaseElementTemplate" >
     ...
     <xsl:call-template name="SplitString">
       ...
       <xsl:with-param name="elementName" select="'bpmn2:extensionDefinitions'" />
       <xsl:with-param name="elementNamespace" select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
     </xsl:call-template>
	</xsl:template>
	...
	<xsl:template name="CallActivityTemplate" >
     ...
     <xsl:if test="@calledElementRef"><xsl:attribute name="calledElementRef"> <xsl:value-of select="@calledElementRef" /> </xsl:attribute></xsl:if>			
	</xsl:template>
	...
	<xsl:template name="CallableElementTemplate" >
     ...
     <xsl:call-template name="SplitString">
       ...
       <xsl:with-param name="elementName" select="'bpmn2:supportedInterfaceRefs'" />
       <xsl:with-param name="elementNamespace" select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
     </xsl:call-template>
     <xsl:for-each select="ioSpecification">			
      <bpmn2:ioSpecification>
	...
	<xsl:template name="CatchEventTemplate" >
     ...
     <xsl:call-template name="SplitString">
       ...
       <xsl:with-param name="elementName" select="'bpmn2:eventDefinitionRefs'" />
       <xsl:with-param name="elementNamespace" select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
     </xsl:call-template>
	</xsl:template>
	...
	<xsl:template name="ChoreographyActivityTemplate" >
     ...
     <xsl:call-template name="SplitString">
       ...
       <xsl:with-param name="elementName" select="'bpmn2:participantRefs'" />
       <xsl:with-param name="elementNamespace" select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
     </xsl:call-template>
	...
	<xsl:template name="ConversationNodeTemplate" >
     ...
     <xsl:call-template name="SplitString">
       ...
       <xsl:with-param name="elementName" select="'bpmn2:messageFlowRefs'" />
       <xsl:with-param name="elementNamespace" select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
     </xsl:call-template>
     <xsl:for-each select="correlationKeys">			
      <bpmn2:correlationKey>
	...
	<xsl:template name="DefinitionsTemplate"  match="//bpmn2xmi:Definitions" >   <bpmn2:definitions>
     <xsl:call-template name="BaseElementTemplate"/> 
	...
	<xsl:template name="LaneTemplate" >
     ...
     <xsl:call-template name="SplitString">
       ...
       <xsl:with-param name="elementName" select="'bpmn2:flowNodeRefs'" />
       <xsl:with-param name="elementNamespace" select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
     </xsl:call-template>
	...
	<xsl:template name="OperationTemplate" >
     ...
     <xsl:call-template name="SplitString">
       ...
       <xsl:with-param name="elementName" select="'bpmn2:errorRefs'" />
       <xsl:with-param name="elementNamespace" select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
     </xsl:call-template>
	</xsl:template>
	...
	<xsl:template name="ParticipantTemplate" >
     ...
     <xsl:call-template name="SplitString">
       ...
       <xsl:with-param name="elementName" select="'bpmn2:interfaceRefs'" />
       <xsl:with-param name="elementNamespace" select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
     </xsl:call-template>
     <xsl:call-template name="SplitString">
       <xsl:with-param name="list" select="@endPointRefs" />
       <xsl:with-param name="elementName" select="'bpmn2:endPointRefs'" />
       <xsl:with-param name="elementNamespace" select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
     </xsl:call-template>
	...
	<xsl:template name="RelationshipTemplate" >
     ...
     <xsl:call-template name="SplitString">
       ...
       <xsl:with-param name="elementName" select="'bpmn2:sources'" />
       <xsl:with-param name="elementNamespace" select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
     </xsl:call-template>
     <xsl:call-template name="SplitString">
       <xsl:with-param name="list" select="@targets" />
       <xsl:with-param name="elementName" select="'bpmn2:targets'" />
       <xsl:with-param name="elementNamespace" select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
     </xsl:call-template>
	</xsl:template>
