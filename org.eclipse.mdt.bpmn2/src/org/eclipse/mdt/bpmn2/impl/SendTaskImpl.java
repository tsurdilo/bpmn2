 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.SendTaskImpl#getMessageRef <em>Message Ref</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.SendTaskImpl#getOperationRef <em>Operation Ref</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.SendTaskImpl#getServiceReferenceRef <em>Service Reference Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SendTaskImpl extends TaskImpl implements SendTask {
    ...
    public void setServiceReferenceRef(QName newServiceReferenceRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.SEND_TASK__SERVICE_REFERENCE_REF,
