 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.InterfaceImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.InterfaceImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
    ...
    public EList<Operation> getOperation() {
        if (operation == null) {
            operation = new EObjectContainmentEList<Operation>(Operation.class,
                    this, Bpmn2Package.INTERFACE__OPERATION);
        }
        return operation;
    }
