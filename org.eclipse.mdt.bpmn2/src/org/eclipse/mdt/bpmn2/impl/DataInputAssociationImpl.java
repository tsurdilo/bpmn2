 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.DataInputAssociationImpl#getSourceRef <em>Source Ref</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.DataInputAssociationImpl#getTargetRef <em>Target Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
    ...
    public EList<String> getSourceRef() {
        if (sourceRef == null) {
            sourceRef = new EDataTypeEList<String>(String.class, this,
                    Bpmn2Package.DATA_INPUT_ASSOCIATION__SOURCE_REF);
        }
        return sourceRef;
    }
    ...
    public void setTargetRef(String newTargetRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.DATA_INPUT_ASSOCIATION__TARGET_REF,
