 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.GlobalScriptTaskImpl#getScript <em>Script</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.GlobalScriptTaskImpl#getScriptLanguage <em>Script Language</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
    ...
    public NotificationChain basicSetScript(Script newScript,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, Bpmn2Package.GLOBAL_SCRIPT_TASK__SCRIPT,
                    oldScript, newScript);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setScript(Script newScript) {
        if (newScript != script) {
            ...
            if (script != null)
                msgs = ((InternalEObject) script).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - Bpmn2Package.GLOBAL_SCRIPT_TASK__SCRIPT,
                        null, msgs);
            if (newScript != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.GLOBAL_SCRIPT_TASK__SCRIPT, newScript,
                    newScript));
    }
