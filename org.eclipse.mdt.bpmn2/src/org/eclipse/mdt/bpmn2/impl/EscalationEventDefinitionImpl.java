 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.EscalationEventDefinitionImpl#getEscalationCode <em>Escalation Code</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.EscalationEventDefinitionImpl#getEscalationRef <em>Escalation Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EscalationEventDefinitionImpl extends EventDefinitionImpl
    ...
    public void setEscalationCode(String newEscalationCode) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.ESCALATION_EVENT_DEFINITION__ESCALATION_CODE,
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case Bpmn2Package.ESCALATION_EVENT_DEFINITION__ESCALATION_CODE:
