 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.ScriptTaskImpl#getScript <em>Script</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.ScriptTaskImpl#getScriptLanguage <em>Script Language</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScriptTaskImpl extends TaskImpl implements ScriptTask {
    ...
    public NotificationChain basicSetScript(Script newScript,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, Bpmn2Package.SCRIPT_TASK__SCRIPT,
                    oldScript, newScript);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setScript(Script newScript) {
        if (newScript != script) {
            ...
            if (script != null)
                msgs = ((InternalEObject) script).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - Bpmn2Package.SCRIPT_TASK__SCRIPT, null, msgs);
            if (newScript != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.SCRIPT_TASK__SCRIPT, newScript, newScript));
    }
    ...
    public void setScriptLanguage(String newScriptLanguage) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.SCRIPT_TASK__SCRIPT_LANGUAGE,
