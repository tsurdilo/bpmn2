 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.UserTaskImpl#getRendering <em>Rendering</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.UserTaskImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.UserTaskImpl#getInMessageRef <em>In Message Ref</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.UserTaskImpl#getOutMessageRef <em>Out Message Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserTaskImpl extends TaskImpl implements UserTask {
    ...
    public EList<Rendering> getRendering() {
        if (rendering == null) {
            rendering = new EObjectContainmentEList<Rendering>(Rendering.class,
                    this, Bpmn2Package.USER_TASK__RENDERING);
        }
        return rendering;
    }
    ...
    public void setInMessageRef(QName newInMessageRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.USER_TASK__IN_MESSAGE_REF, oldInMessageRef,
                    inMessageRef));
    }
    ...
    public void setOutMessageRef(QName newOutMessageRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.USER_TASK__OUT_MESSAGE_REF, oldOutMessageRef,
                    outMessageRef));
    }
