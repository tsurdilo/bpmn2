 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.MessageImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.MessageImpl#getStructureRef <em>Structure Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageImpl extends RootElementImpl implements Message {
    ...
    public void setStructureRef(QName newStructureRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.MESSAGE__STRUCTURE_REF, oldStructureRef,
                    structureRef));
    }
