 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.TextAnnotationImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
    ...
    public NotificationChain basicSetText(Text newText, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, Bpmn2Package.TEXT_ANNOTATION__TEXT,
                    oldText, newText);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setText(Text newText) {
        if (newText != text) {
            ...
            if (text != null)
                msgs = ((InternalEObject) text).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - Bpmn2Package.TEXT_ANNOTATION__TEXT, null,
                        msgs);
            if (newText != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.TEXT_ANNOTATION__TEXT, newText, newText));
    }
