 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.DataOutputImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn2.impl.DataOutputImpl#getStructureDefinitionRef <em>Structure Definition Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataOutputImpl extends BaseElementImpl implements DataOutput {
    ...
    public void setStructureDefinitionRef(QName newStructureDefinitionRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.DATA_OUTPUT__STRUCTURE_DEFINITION_REF,
