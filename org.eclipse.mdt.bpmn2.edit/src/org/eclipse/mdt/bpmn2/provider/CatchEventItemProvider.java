...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn2.CatchEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CatchEventItemProvider extends EventItemProvider implements
    ...
    protected void addEventDefinitionRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_CatchEvent_eventDefinitionRef_feature"),
                getString("_UI_PropertyDescriptor_description",
                        "_UI_CatchEvent_eventDefinitionRef_feature",
                        "_UI_CatchEvent_type"), Bpmn2Package.eINSTANCE
                        .getCatchEvent_EventDefinitionRef(), true, false,
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(Bpmn2Package.eINSTANCE
                .getCatchEvent_OutputSet(), Bpmn2Factory.eINSTANCE
                .createOutputSet()));

        newChildDescriptors.add(createChildParameter(Bpmn2Package.eINSTANCE
                .getCatchEvent_DataOutput(), Bpmn2Factory.eINSTANCE
                .createDataOutput()));

        newChildDescriptors.add(createChildParameter(Bpmn2Package.eINSTANCE
                .getCatchEvent_DataOutputAssociation(), Bpmn2Factory.eINSTANCE
