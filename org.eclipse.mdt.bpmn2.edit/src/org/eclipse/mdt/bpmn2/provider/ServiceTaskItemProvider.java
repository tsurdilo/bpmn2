...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn2.ServiceTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceTaskItemProvider extends TaskItemProvider implements
    ...
    protected void addMessageRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_ServiceTask_messageRef_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_ServiceTask_messageRef_feature",
                        "_UI_ServiceTask_type"), Bpmn2Package.eINSTANCE
                        .getServiceTask_MessageRef(), true, false, false,
    ...
    protected void addOperationRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ServiceTask_operationRef_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_ServiceTask_operationRef_feature",
                        "_UI_ServiceTask_type"), Bpmn2Package.eINSTANCE
                        .getServiceTask_OperationRef(), true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addServiceReferenceRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ServiceTask_serviceReferenceRef_feature"),
                getString("_UI_PropertyDescriptor_description",
                        "_UI_ServiceTask_serviceReferenceRef_feature",
                        "_UI_ServiceTask_type"), Bpmn2Package.eINSTANCE
                        .getServiceTask_ServiceReferenceRef(), true, false,
