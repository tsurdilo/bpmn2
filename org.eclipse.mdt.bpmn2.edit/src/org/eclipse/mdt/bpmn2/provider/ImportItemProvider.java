...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn2.Import} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImportItemProvider extends ItemProviderAdapter implements
    ...
    protected void addImportTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_Import_importType_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_Import_importType_feature", "_UI_Import_type"),
                Bpmn2Package.eINSTANCE.getImport_ImportType(), true, false,
    ...
    protected void addLocationPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Import_location_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_Import_location_feature", "_UI_Import_type"),
                Bpmn2Package.eINSTANCE.getImport_Location(), true, false,
                false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addNamespacePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Import_namespace_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_Import_namespace_feature", "_UI_Import_type"),
                Bpmn2Package.eINSTANCE.getImport_Namespace(), true, false,
                false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
