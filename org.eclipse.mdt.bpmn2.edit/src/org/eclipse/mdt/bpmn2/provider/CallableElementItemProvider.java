...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn2.CallableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallableElementItemProvider extends RootElementItemProvider
    ...
    protected void addInterfaceRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_CallableElement_interfaceRef_feature"),
                getString("_UI_PropertyDescriptor_description",
                        "_UI_CallableElement_interfaceRef_feature",
                        "_UI_CallableElement_type"), Bpmn2Package.eINSTANCE
                        .getCallableElement_InterfaceRef(), true, false, false,
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_CallableElement_name_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_CallableElement_name_feature",
                        "_UI_CallableElement_type"), Bpmn2Package.eINSTANCE
                        .getCallableElement_Name(), true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(Bpmn2Package.eINSTANCE
                .getCallableElement_IoSpecification(), Bpmn2Factory.eINSTANCE
                .createInputOutputSpecification()));

        newChildDescriptors.add(createChildParameter(Bpmn2Package.eINSTANCE
                .getCallableElement_IoBinding(), Bpmn2Factory.eINSTANCE
