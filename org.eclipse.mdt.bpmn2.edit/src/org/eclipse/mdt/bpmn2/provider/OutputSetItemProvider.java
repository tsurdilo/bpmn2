...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn2.OutputSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputSetItemProvider extends BaseElementItemProvider implements
    ...
    protected void addDataOutputRefsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_OutputSet_dataOutputRefs_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_OutputSet_dataOutputRefs_feature",
                        "_UI_OutputSet_type"), Bpmn2Package.eINSTANCE
                        .getOutputSet_DataOutputRefs(), true, false, false,
    ...
    protected void addInputSetRefsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_OutputSet_inputSetRefs_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_OutputSet_inputSetRefs_feature",
                        "_UI_OutputSet_type"), Bpmn2Package.eINSTANCE
                        .getOutputSet_InputSetRefs(), true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_OutputSet_name_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_OutputSet_name_feature", "_UI_OutputSet_type"),
                Bpmn2Package.eINSTANCE.getOutputSet_Name(), true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
