...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn2.Extension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtensionItemProvider extends ItemProviderAdapter implements
    ...
    protected void addDefinitionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_Extension_definition_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_Extension_definition_feature",
                        "_UI_Extension_type"), Bpmn2Package.eINSTANCE
                        .getExtension_Definition(), true, false, false,
    ...
    protected void addMustUnderstandPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Extension_mustUnderstand_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_Extension_mustUnderstand_feature",
                        "_UI_Extension_type"), Bpmn2Package.eINSTANCE
                        .getExtension_MustUnderstand(), true, false, false,
    ...
    public void notifyChanged(Notification notification) {
        ...
        case Bpmn2Package.EXTENSION__MUST_UNDERSTAND:
            ...
            return;
        case Bpmn2Package.EXTENSION__DOCUMENTATION:
            fireNotifyChanged(new ViewerNotification(notification, notification
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(Bpmn2Package.eINSTANCE
                .getExtension_Documentation(), Bpmn2Factory.eINSTANCE
                .createDocumentation()));
    }
