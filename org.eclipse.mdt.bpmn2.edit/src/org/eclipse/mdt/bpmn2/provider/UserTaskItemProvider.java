...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn2.UserTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserTaskItemProvider extends TaskItemProvider implements
    ...
    protected void addImplementationPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_UserTask_implementation_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_UserTask_implementation_feature",
                        "_UI_UserTask_type"), Bpmn2Package.eINSTANCE
                        .getUserTask_Implementation(), true, false, false,
    ...
    protected void addInMessageRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_UserTask_inMessageRef_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_UserTask_inMessageRef_feature",
                        "_UI_UserTask_type"), Bpmn2Package.eINSTANCE
                        .getUserTask_InMessageRef(), true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addOutMessageRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_UserTask_outMessageRef_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_UserTask_outMessageRef_feature",
                        "_UI_UserTask_type"), Bpmn2Package.eINSTANCE
                        .getUserTask_OutMessageRef(), true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures
                    .add(Bpmn2Package.eINSTANCE.getUserTask_Rendering());
        }
    ...
    public void notifyChanged(Notification notification) {
        ...
        case Bpmn2Package.USER_TASK__IN_MESSAGE_REF:
        case Bpmn2Package.USER_TASK__OUT_MESSAGE_REF:
            fireNotifyChanged(new ViewerNotification(notification, notification
                    .getNotifier(), false, true));
            return;
        case Bpmn2Package.USER_TASK__RENDERING:
            fireNotifyChanged(new ViewerNotification(notification, notification
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(Bpmn2Package.eINSTANCE
                .getUserTask_Rendering(), Bpmn2Factory.eINSTANCE
                .createRendering()));
    }
