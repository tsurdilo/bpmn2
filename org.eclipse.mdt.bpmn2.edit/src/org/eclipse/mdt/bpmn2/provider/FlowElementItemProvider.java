...
/**
 * This is the item provider adapter for a {@link org.eclipse.mdt.bpmn2.FlowElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowElementItemProvider extends BaseElementItemProvider implements
    ...
    protected void addCategoryValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_FlowElement_categoryValue_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_FlowElement_categoryValue_feature",
                        "_UI_FlowElement_type"), Bpmn2Package.eINSTANCE
                        .getFlowElement_CategoryValue(), true, false, false,
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ((ComposeableAdapterFactory) adapterFactory)
                                .getRootAdapterFactory(), getResourceLocator(),
                        getString("_UI_FlowElement_name_feature"), getString(
                                "_UI_PropertyDescriptor_description",
                                "_UI_FlowElement_name_feature",
                                "_UI_FlowElement_type"), Bpmn2Package.eINSTANCE
                                .getFlowElement_Name(), true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(Bpmn2Package.eINSTANCE
                .getFlowElement_Auditing(), Bpmn2Factory.eINSTANCE
                .createAuditing()));

        newChildDescriptors.add(createChildParameter(Bpmn2Package.eINSTANCE
                .getFlowElement_Monitoring(), Bpmn2Factory.eINSTANCE
                .createMonitoring()));
    }
