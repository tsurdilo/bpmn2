 ...
 * @generated
 */
public class Bpmn2ActionBarContributor extends
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(
                BPMN20EditorPlugin.INSTANCE.getString("_UI_Bpmn2Editor_menu"),
                "org.eclipse.mdt.bpmn2MenuID");
        ...
        //
        createChildMenuManager = new MenuManager(BPMN20EditorPlugin.INSTANCE
                .getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(BPMN20EditorPlugin.INSTANCE
    ...
    public void menuAboutToShow(IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(BPMN20EditorPlugin.INSTANCE
                .getString("_UI_CreateChild_menu_item"));
