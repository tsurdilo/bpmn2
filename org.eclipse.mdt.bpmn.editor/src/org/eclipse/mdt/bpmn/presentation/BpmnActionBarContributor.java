 ...
 * @generated
 */
public class BpmnActionBarContributor extends EditingDomainActionBarContributor
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("bpmn-settings")); //$NON-NLS-1$
        toolBarManager.add(new Separator("bpmn-additions")); //$NON-NLS-1$
    }
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(BpmnEditorPlugin.INSTANCE
                .getString("_UI_BpmnEditor_menu"), "org.eclipse.mdt.bpmnMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
