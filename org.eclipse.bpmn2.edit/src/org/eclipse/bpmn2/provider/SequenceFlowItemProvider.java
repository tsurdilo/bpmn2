 ...
 * @generated
 */
public class SequenceFlowItemProvider extends FlowElementItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    /**
    ...
    protected void addIsImmediatePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_SequenceFlow_isImmediate_feature"), getString("_UI_PropertyDescriptor_description", "_UI_SequenceFlow_isImmediate_feature", "_UI_SequenceFlow_type"), Bpmn2Package.Literals.SEQUENCE_FLOW__IS_IMMEDIATE, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addTargetRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_SequenceFlow_targetRef_feature"), getString("_UI_PropertyDescriptor_description", "_UI_SequenceFlow_targetRef_feature", "_UI_SequenceFlow_type"), Bpmn2Package.Literals.SEQUENCE_FLOW__TARGET_REF, true, false, true, null, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_SequenceFlow_type") : getString("_UI_SequenceFlow_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(Bpmn2Package.Literals.SEQUENCE_FLOW__CONDITION_EXPRESSION, Bpmn2Factory.eINSTANCE.createExpression()));

        newChildDescriptors.add(createChildParameter(Bpmn2Package.Literals.SEQUENCE_FLOW__CONDITION_EXPRESSION, Bpmn2Factory.eINSTANCE.createFormalExpression()));
    }
