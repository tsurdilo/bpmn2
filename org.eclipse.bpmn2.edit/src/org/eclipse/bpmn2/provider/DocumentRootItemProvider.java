...
import org.eclipse.bpmn2.bpmn2di.Bpmn2DiFactory;
...
public class DocumentRootItemProvider
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.Literals.DOCUMENT_ROOT__BASE_ELEMENT_WITH_MIXED_CONTENT,
				 Bpmn2DiFactory.eINSTANCE.createBPMNDiagram()));

		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.Literals.DOCUMENT_ROOT__BASE_ELEMENT_WITH_MIXED_CONTENT,
				 Bpmn2DiFactory.eINSTANCE.createBPMNEdge()));

		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.Literals.DOCUMENT_ROOT__BASE_ELEMENT_WITH_MIXED_CONTENT,
				 Bpmn2DiFactory.eINSTANCE.createBPMNLabel()));

		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.Literals.DOCUMENT_ROOT__BASE_ELEMENT_WITH_MIXED_CONTENT,
				 Bpmn2DiFactory.eINSTANCE.createBPMNLabelStyle()));

		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.Literals.DOCUMENT_ROOT__BASE_ELEMENT_WITH_MIXED_CONTENT,
				 Bpmn2DiFactory.eINSTANCE.createBPMNPlane()));

		newChildDescriptors.add
			(createChildParameter
				(Bpmn2Package.Literals.DOCUMENT_ROOT__BASE_ELEMENT_WITH_MIXED_CONTENT,
				 Bpmn2DiFactory.eINSTANCE.createBPMNShape()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Bpmn2Package.Literals.DOCUMENT_ROOT__ACTIVITY ||
