...
/**
 * This is the action bar contributor for the DI model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DIActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction refreshViewerAction = new Action(
            BpmnEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
    {
        @Override
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("di-settings")); //$NON-NLS-1$
        toolBarManager.add(new Separator("di-additions")); //$NON-NLS-1$
    }
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(BpmnEditorPlugin.INSTANCE
                .getString("_UI_DIEditor_menu"), "org.eclipse.bpmn.diMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        //
        createChildMenuManager = new MenuManager(BpmnEditorPlugin.INSTANCE
                .getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
        submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(BpmnEditorPlugin.INSTANCE
    ...
    public void menuAboutToShow(IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(BpmnEditorPlugin.INSTANCE
                .getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
