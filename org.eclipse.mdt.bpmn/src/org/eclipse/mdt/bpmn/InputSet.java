 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn.InputSet#getDataInputRefs <em>Data Input Refs</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.InputSet#getOptionalInputRefs <em>Optional Input Refs</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.InputSet#getWhileExecutingInputRefs <em>While Executing Input Refs</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.InputSet#getOutputSetRefs <em>Output Set Refs</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.InputSet#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.mdt.bpmn.bpmnPackage#getInputSet()
...
public interface InputSet extends BaseElement {
     ...
     * @see org.eclipse.mdt.bpmn.bpmnPackage#getInputSet_DataInputRefs()
     ...
     * @see org.eclipse.mdt.bpmn.bpmnPackage#getInputSet_OptionalInputRefs()
     * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.IDREF"
     ...
     * @see org.eclipse.mdt.bpmn.bpmnPackage#getInputSet_WhileExecutingInputRefs()
     * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.IDREF"
     ...
     * @see org.eclipse.mdt.bpmn.bpmnPackage#getInputSet_OutputSetRefs()
     * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.IDREF"
     ...
     * @see #setName(String)
     * @see org.eclipse.mdt.bpmn.bpmnPackage#getInputSet_Name()
    ...
    /**
     * Sets the value of the '{@link org.eclipse.mdt.bpmn.InputSet#getName <em>Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
