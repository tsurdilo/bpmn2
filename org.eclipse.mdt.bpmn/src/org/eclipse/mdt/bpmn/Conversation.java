 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn.Conversation#getConversationNodeGroup <em>Conversation Node Group</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.Conversation#getConversationNode <em>Conversation Node</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.Conversation#getParticipant <em>Participant</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.Conversation#getArtifactGroup <em>Artifact Group</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.Conversation#getArtifact <em>Artifact</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.Conversation#getMessageFlow <em>Message Flow</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.Conversation#getMessageFlowRef <em>Message Flow Ref</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.Conversation#getCorrelationKey <em>Correlation Key</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Conversation extends CallableElement {
     ...
     * The list contents are of type {@link org.eclipse.mdt.bpmn.ConversationNode}.
     * <!-- begin-user-doc -->
     * <p>
