 ...
 * <ul>
 *   <li>{@link org.eclipse.mdt.bpmn.impl.DataOutputImpl#getDataState <em>Data State</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.impl.DataOutputImpl#isIsCollection <em>Is Collection</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.impl.DataOutputImpl#getItemSubjectRef <em>Item Subject Ref</em>}</li>
 *   <li>{@link org.eclipse.mdt.bpmn.impl.DataOutputImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataOutputImpl extends BaseElementImpl implements DataOutput {
    ...
    protected EClass eStaticClass() {
        return bpmnPackage.eINSTANCE.getDataOutput();
    }
    ...
    public void unsetIsCollection() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, bpmnPackage.DATA_OUTPUT__IS_COLLECTION, oldIsCollection, IS_COLLECTION_EDEFAULT, oldIsCollectionESet));
    }
