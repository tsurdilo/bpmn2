 ...
 * @generated
 */
public class ProcessImpl extends CallableElementImpl implements org.eclipse.mdt.bpmn.Process {
    /**
    ...
    public void setDefinitionalCollaborationRef(QName newDefinitionalCollaborationRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, bpmnPackage.PROCESS__DEFINITIONAL_COLLABORATION_REF, oldDefinitionalCollaborationRef, definitionalCollaborationRef));
    }
    ...
    public void unsetProcessType() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, bpmnPackage.PROCESS__PROCESS_TYPE, oldProcessType, PROCESS_TYPE_EDEFAULT, oldProcessTypeESet));
    }
    ...
    public String toString() {
        ...
        if (processTypeESet) result.append(processType); else result.append("<unset>"); //$NON-NLS-1$
        result.append(')');
