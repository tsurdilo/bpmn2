...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn.BusinessRuleTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BusinessRuleTaskItemProvider extends TaskItemProvider implements
        ...
        try {
            return overlayImage(
                    ...
                    getResourceLocator().getImage(
                            "full/obj16/BusinessRuleTask.png")); //$NON-NLS-1$
        } catch (java.util.MissingResourceException e) {
            return overlayImage(
                    object,
                    getResourceLocator().getImage(
                            "full/obj16/BusinessRuleTask.gif")); //$NON-NLS-1$
        }
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_BusinessRuleTask_type") : //$NON-NLS-1$
                getString("_UI_BusinessRuleTask_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
