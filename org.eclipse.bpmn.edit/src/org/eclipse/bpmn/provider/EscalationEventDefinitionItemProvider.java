...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn.EscalationEventDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EscalationEventDefinitionItemProvider extends
    ...
    /**
     * This returns EscalationEventDefinition.png.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
        ...
        try {
            return overlayImage(
                    ...
                    getResourceLocator().getImage(
                            "full/obj16/EscalationEventDefinition.png")); //$NON-NLS-1$
        } catch (java.util.MissingResourceException e) {
            return overlayImage(
                    object,
                    getResourceLocator().getImage(
                            "full/obj16/EscalationEventDefinition.gif")); //$NON-NLS-1$
        }
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_EscalationEventDefinition_type") : //$NON-NLS-1$
                getString("_UI_EscalationEventDefinition_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
