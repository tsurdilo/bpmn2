...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn.CorrelationProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CorrelationPropertyItemProvider extends RootElementItemProvider
    ...
    public String getText(Object object) {
        String label = ((CorrelationProperty) object).getId();
        return label == null || label.length() == 0 ? getString("_UI_CorrelationProperty_type") : //$NON-NLS-1$
                getString("_UI_CorrelationProperty_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
