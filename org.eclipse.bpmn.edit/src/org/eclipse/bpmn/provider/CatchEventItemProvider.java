...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn.CatchEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CatchEventItemProvider extends EventItemProvider implements
    ...
    protected void addEventDefinitionRefsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ...
                        getResourceLocator(),
                        getString("_UI_CatchEvent_eventDefinitionRefs_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_CatchEvent_eventDefinitionRefs_feature", "_UI_CatchEvent_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        BpmnPackage.eINSTANCE
                                .getCatchEvent_EventDefinitionRefs(), true,
                        false, false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(BpmnPackage.eINSTANCE
                    .getCatchEvent_DataOutputAssociations());
            childrenFeatures.add(BpmnPackage.eINSTANCE
