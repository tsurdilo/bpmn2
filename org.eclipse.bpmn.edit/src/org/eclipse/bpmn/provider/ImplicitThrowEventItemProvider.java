...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn.ImplicitThrowEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImplicitThrowEventItemProvider extends ThrowEventItemProvider
    ...
    /**
     * This returns ImplicitThrowEvent.png.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
        ...
        try {
            return overlayImage(
                    ...
                    getResourceLocator().getImage(
                            "full/obj16/ImplicitThrowEvent.png")); //$NON-NLS-1$
        } catch (java.util.MissingResourceException e) {
            return overlayImage(
                    object,
                    getResourceLocator().getImage(
                            "full/obj16/ImplicitThrowEvent.gif")); //$NON-NLS-1$
        }
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ImplicitThrowEvent_type") : //$NON-NLS-1$
                getString("_UI_ImplicitThrowEvent_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
