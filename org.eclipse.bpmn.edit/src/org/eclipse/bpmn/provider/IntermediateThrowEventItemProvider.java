...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn.IntermediateThrowEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntermediateThrowEventItemProvider extends ThrowEventItemProvider
        ...
        try {
            return overlayImage(
                    ...
                    getResourceLocator().getImage(
                            "full/obj16/IntermediateThrowEvent.png")); //$NON-NLS-1$
        } catch (java.util.MissingResourceException e) {
            return overlayImage(
                    object,
                    getResourceLocator().getImage(
                            "full/obj16/IntermediateThrowEvent.gif")); //$NON-NLS-1$
        }
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_IntermediateThrowEvent_type") : //$NON-NLS-1$
                getString("_UI_IntermediateThrowEvent_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
