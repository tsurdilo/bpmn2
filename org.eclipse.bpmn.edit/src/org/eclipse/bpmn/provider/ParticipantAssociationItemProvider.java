...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn.ParticipantAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParticipantAssociationItemProvider extends BaseElementItemProvider
    ...
    protected void addInnerParticipantRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ...
                        getResourceLocator(),
                        getString("_UI_ParticipantAssociation_innerParticipantRef_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_ParticipantAssociation_innerParticipantRef_feature", "_UI_ParticipantAssociation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ((ComposeableAdapterFactory) adapterFactory)
                                .getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_ParticipantAssociation_outerParticipantRef_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_ParticipantAssociation_outerParticipantRef_feature", "_UI_ParticipantAssociation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        BpmnPackage.eINSTANCE
        ...
        try {
            return overlayImage(
                    ...
                    getResourceLocator().getImage(
                            "full/obj16/ParticipantAssociation.png")); //$NON-NLS-1$
        } catch (java.util.MissingResourceException e) {
            return overlayImage(
                    object,
                    getResourceLocator().getImage(
                            "full/obj16/ParticipantAssociation.gif")); //$NON-NLS-1$
        }
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ParticipantAssociation_type") : //$NON-NLS-1$
                getString("_UI_ParticipantAssociation_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ParticipantAssociation.class)) {
