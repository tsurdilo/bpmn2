...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn.Resource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceItemProvider extends RootElementItemProvider implements
    ...
    public Object getImage(Object object) {
        try {
            return overlayImage(object,
                    getResourceLocator().getImage("full/obj16/Resource.png")); //$NON-NLS-1$
        } catch (java.util.MissingResourceException e) {
            return overlayImage(object,
                    getResourceLocator().getImage("full/obj16/Resource.gif")); //$NON-NLS-1$
        }
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(
                BpmnPackage.eINSTANCE.getResource_ResourceParameter(),
