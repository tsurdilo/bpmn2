...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn.DataInput} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataInputItemProvider extends BaseElementItemProvider implements
    ...
    public Object getImage(Object object) {
        try {
            return overlayImage(object,
                    getResourceLocator().getImage("full/obj16/DataInput.png")); //$NON-NLS-1$
        } catch (java.util.MissingResourceException e) {
            return overlayImage(object,
                    getResourceLocator().getImage("full/obj16/DataInput.gif")); //$NON-NLS-1$
        }
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_DataInput_type") : //$NON-NLS-1$
                getString("_UI_DataInput_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(
                BpmnPackage.eINSTANCE.getDataInput_DataState(),
