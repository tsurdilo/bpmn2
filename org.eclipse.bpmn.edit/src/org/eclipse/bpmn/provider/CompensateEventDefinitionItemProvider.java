...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn.CompensateEventDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompensateEventDefinitionItemProvider extends
    ...
    protected void addActivityRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ...
                        getResourceLocator(),
                        getString("_UI_CompensateEventDefinition_activityRef_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_CompensateEventDefinition_activityRef_feature", "_UI_CompensateEventDefinition_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ((ComposeableAdapterFactory) adapterFactory)
                                .getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_CompensateEventDefinition_waitForCompletion_feature"), //$NON-NLS-1$
                        getString(
                                "_UI_PropertyDescriptor_description", "_UI_CompensateEventDefinition_waitForCompletion_feature", "_UI_CompensateEventDefinition_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        BpmnPackage.eINSTANCE
        ...
        try {
            return overlayImage(
                    ...
                    getResourceLocator().getImage(
                            "full/obj16/CompensateEventDefinition.png")); //$NON-NLS-1$
        } catch (java.util.MissingResourceException e) {
            return overlayImage(
                    object,
                    getResourceLocator().getImage(
                            "full/obj16/CompensateEventDefinition.gif")); //$NON-NLS-1$
        }
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_CompensateEventDefinition_type") : //$NON-NLS-1$
                getString("_UI_CompensateEventDefinition_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
