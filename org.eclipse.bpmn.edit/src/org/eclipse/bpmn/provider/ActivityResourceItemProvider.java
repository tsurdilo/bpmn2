...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn.ActivityResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityResourceItemProvider extends BaseElementItemProvider
     ...
     * @generated
     */
    public ActivityResourceItemProvider(AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(BpmnPackage.eINSTANCE
                    .getActivityResource_ResourceParameterBindings());
        }
    ...
    /**
     * This returns ActivityResource.png.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = ((ActivityResource) object).getId();
        return label == null || label.length() == 0 ? getString("_UI_ActivityResource_type") : //$NON-NLS-1$
                getString("_UI_ActivityResource_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
