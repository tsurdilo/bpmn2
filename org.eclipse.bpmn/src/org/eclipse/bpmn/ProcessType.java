 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.bpmn.BpmnPackage#getProcessType()
...
public enum ProcessType implements Enumerator {
     ...
     * @ordered
     */
    EXECUTABLE(1, "executable", "executable"), //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * @ordered
     */
    NON_EXECUTABLE(2, "nonExecutable", "non-executable"), //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * @ordered
     */
    PUBLIC(3, "public", "public"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * @generated
     */
    private static final ProcessType[] VALUES_ARRAY = new ProcessType[] { NONE, EXECUTABLE, NON_EXECUTABLE, PUBLIC, };
