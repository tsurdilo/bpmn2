 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn.ThrowEvent#getDataInput <em>Data Input</em>}</li>
 *   <li>{@link org.eclipse.bpmn.ThrowEvent#getDataInputAssociation <em>Data Input Association</em>}</li>
 *   <li>{@link org.eclipse.bpmn.ThrowEvent#getInputSet <em>Input Set</em>}</li>
 *   <li>{@link org.eclipse.bpmn.ThrowEvent#getEventDefinitionGroup <em>Event Definition Group</em>}</li>
 *   <li>{@link org.eclipse.bpmn.ThrowEvent#getEventDefinition <em>Event Definition</em>}</li>
 *   <li>{@link org.eclipse.bpmn.ThrowEvent#getEventDefinitionRef <em>Event Definition Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.bpmn.BpmnPackage#getThrowEvent()
 * @model abstract="true"
...
public interface ThrowEvent extends Event {
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getThrowEvent_DataInput()
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getThrowEvent_DataInputAssociation()
     * @model containment="true"
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getThrowEvent_InputSet()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link org.eclipse.bpmn.ThrowEvent#getInputSet <em>Input Set</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getThrowEvent_EventDefinitionGroup()
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getThrowEvent_EventDefinition()
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getThrowEvent_EventDefinitionRef()
