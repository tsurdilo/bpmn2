 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn.impl.DataStoreImpl#getDataState <em>Data State</em>}</li>
 *   <li>{@link org.eclipse.bpmn.impl.DataStoreImpl#getCapacity <em>Capacity</em>}</li>
 *   <li>{@link org.eclipse.bpmn.impl.DataStoreImpl#isIsUnlimited <em>Is Unlimited</em>}</li>
 *   <li>{@link org.eclipse.bpmn.impl.DataStoreImpl#getItemSubjectRef <em>Item Subject Ref</em>}</li>
 *   <li>{@link org.eclipse.bpmn.impl.DataStoreImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataStoreImpl extends RootElementImpl implements DataStore {
    ...
    public void unsetIsUnlimited() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, BpmnPackage.DATA_STORE__IS_UNLIMITED, oldIsUnlimited, IS_UNLIMITED_EDEFAULT,
                    oldIsUnlimitedESet));
    }
