 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn.impl.DataObjectImpl#getDataState <em>Data State</em>}</li>
 *   <li>{@link org.eclipse.bpmn.impl.DataObjectImpl#isIsCollection <em>Is Collection</em>}</li>
 *   <li>{@link org.eclipse.bpmn.impl.DataObjectImpl#getItemSubjectRef <em>Item Subject Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataObjectImpl extends FlowElementImpl implements DataObject {
    ...
    public void unsetIsCollection() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, BpmnPackage.DATA_OBJECT__IS_COLLECTION, oldIsCollection, IS_COLLECTION_EDEFAULT,
                    oldIsCollectionESet));
    }
