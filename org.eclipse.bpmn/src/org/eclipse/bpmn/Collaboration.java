 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn.Collaboration#getParticipant <em>Participant</em>}</li>
 *   <li>{@link org.eclipse.bpmn.Collaboration#getMessageFlow <em>Message Flow</em>}</li>
 *   <li>{@link org.eclipse.bpmn.Collaboration#getArtifactGroup <em>Artifact Group</em>}</li>
 *   <li>{@link org.eclipse.bpmn.Collaboration#getArtifact <em>Artifact</em>}</li>
 *   <li>{@link org.eclipse.bpmn.Collaboration#getConversation <em>Conversation</em>}</li>
 *   <li>{@link org.eclipse.bpmn.Collaboration#getConversationAssociation <em>Conversation Association</em>}</li>
 *   <li>{@link org.eclipse.bpmn.Collaboration#getParticipantAssociation <em>Participant Association</em>}</li>
 *   <li>{@link org.eclipse.bpmn.Collaboration#getMessageFlowAssociation <em>Message Flow Association</em>}</li>
 *   <li>{@link org.eclipse.bpmn.Collaboration#getChoreographyRef <em>Choreography Ref</em>}</li>
 *   <li>{@link org.eclipse.bpmn.Collaboration#isIsClosed <em>Is Closed</em>}</li>
 *   <li>{@link org.eclipse.bpmn.Collaboration#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.bpmn.BpmnPackage#getCollaboration()
...
public interface Collaboration extends RootElement {
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getCollaboration_Participant()
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getCollaboration_MessageFlow()
     * @model containment="true"
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getCollaboration_ArtifactGroup()
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getCollaboration_Artifact()
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getCollaboration_Conversation()
     * @model containment="true"
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getCollaboration_ConversationAssociation()
     * @model containment="true"
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getCollaboration_ParticipantAssociation()
     * @model containment="true"
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getCollaboration_MessageFlowAssociation()
     * @model containment="true"
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getCollaboration_ChoreographyRef()
    ...
    /**
     * Sets the value of the '{@link org.eclipse.bpmn.Collaboration#getChoreographyRef <em>Choreography Ref</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see org.eclipse.bpmn.BpmnPackage#getCollaboration_IsClosed()
    ...
    /**
     * Sets the value of the '{@link org.eclipse.bpmn.Collaboration#isIsClosed <em>Is Closed</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link org.eclipse.bpmn.Collaboration#isIsClosed <em>Is Closed</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetIsClosed()
     * @see #isIsClosed()
    ...
    /**
     * Returns whether the value of the '{@link org.eclipse.bpmn.Collaboration#isIsClosed <em>Is Closed</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setName(String)
     * @see org.eclipse.bpmn.BpmnPackage#getCollaboration_Name()
    ...
    /**
     * Sets the value of the '{@link org.eclipse.bpmn.Collaboration#getName <em>Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
