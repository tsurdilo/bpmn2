 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.BPMNDiagram#getPlane <em>Plane</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.BPMNDiagram#getLabelStyle <em>Label Style</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.bpmn2.bpmn2di.Bpmn2DiPackage#getBPMNDiagram()
...
public interface BPMNDiagram extends Diagram {
	 ...
	 * @see org.eclipse.bpmn2.bpmn2di.Bpmn2DiPackage#getBPMNDiagram_Plane()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.bpmn2di.BPMNDiagram#getPlane <em>Plane</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.eclipse.bpmn2.bpmn2di.BPMNLabelStyle}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.bpmn2.bpmn2di.Bpmn2DiPackage#getBPMNDiagram_LabelStyle()
