...
import org.eclipse.bpmn2.bpmn2di.ParticipantBandKind;

import org.eclipse.di.impl.LabeledShapeImpl;
 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNShapeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNShapeImpl#getBpmnElement <em>Bpmn Element</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNShapeImpl#getChoreographyActivityShape <em>Choreography Activity Shape</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNShapeImpl#isIsExpanded <em>Is Expanded</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNShapeImpl#isIsHorizontal <em>Is Horizontal</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNShapeImpl#isIsMarkerVisible <em>Is Marker Visible</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNShapeImpl#isIsMessageVisible <em>Is Message Visible</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNShapeImpl#getParticipantBandKind <em>Participant Band Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BPMNShapeImpl extends LabeledShapeImpl implements BPMNShape {
	...
	protected EClass eStaticClass() {
		return Bpmn2DiPackage.Literals.BPMN_SHAPE;
	}
	...
	public NotificationChain basicSetLabel(BPMNLabel newLabel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_SHAPE__LABEL, oldLabel, newLabel);
	...
	public void setLabel(BPMNLabel newLabel) {
		if (newLabel != label) {
			...
			if (label != null)
				msgs = ((InternalEObject)label).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Bpmn2DiPackage.BPMN_SHAPE__LABEL, null, msgs);
			if (newLabel != null)
				msgs = ((InternalEObject)newLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Bpmn2DiPackage.BPMN_SHAPE__LABEL, null, msgs);
			msgs = basicSetLabel(newLabel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_SHAPE__LABEL, newLabel, newLabel));
	}
	...
	public BaseElement getBpmnElement() {
		if (bpmnElement != null && bpmnElement.eIsProxy()) {
			...
			if (bpmnElement != oldBpmnElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2DiPackage.BPMN_SHAPE__BPMN_ELEMENT, oldBpmnElement, bpmnElement));
			}
		}
		return bpmnElement;
	}
	...
	public void setBpmnElement(BaseElement newBpmnElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_SHAPE__BPMN_ELEMENT, oldBpmnElement, bpmnElement));
	}
	...
	public BPMNShape getChoreographyActivityShape() {
		if (choreographyActivityShape != null && choreographyActivityShape.eIsProxy()) {
			...
			if (choreographyActivityShape != oldChoreographyActivityShape) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2DiPackage.BPMN_SHAPE__CHOREOGRAPHY_ACTIVITY_SHAPE, oldChoreographyActivityShape, choreographyActivityShape));
			}
		}
	...
	public void setChoreographyActivityShape(BPMNShape newChoreographyActivityShape) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_SHAPE__CHOREOGRAPHY_ACTIVITY_SHAPE, oldChoreographyActivityShape, choreographyActivityShape));
	}
	...
	public void setIsExpanded(boolean newIsExpanded) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_SHAPE__IS_EXPANDED, oldIsExpanded, isExpanded));
	}
	...
	public void setIsHorizontal(boolean newIsHorizontal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_SHAPE__IS_HORIZONTAL, oldIsHorizontal, isHorizontal));
	}
	...
	public void setIsMarkerVisible(boolean newIsMarkerVisible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_SHAPE__IS_MARKER_VISIBLE, oldIsMarkerVisible, isMarkerVisible));
	}
	...
	public void setIsMessageVisible(boolean newIsMessageVisible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_SHAPE__IS_MESSAGE_VISIBLE, oldIsMessageVisible, isMessageVisible));
	}
	...
	public void setParticipantBandKind(ParticipantBandKind newParticipantBandKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_SHAPE__PARTICIPANT_BAND_KIND, oldParticipantBandKind, participantBandKind));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Bpmn2DiPackage.BPMN_SHAPE__LABEL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bpmn2DiPackage.BPMN_SHAPE__LABEL:
				return getLabel();
			case Bpmn2DiPackage.BPMN_SHAPE__BPMN_ELEMENT:
				if (resolve) return getBpmnElement();
				return basicGetBpmnElement();
			case Bpmn2DiPackage.BPMN_SHAPE__CHOREOGRAPHY_ACTIVITY_SHAPE:
				if (resolve) return getChoreographyActivityShape();
				return basicGetChoreographyActivityShape();
			case Bpmn2DiPackage.BPMN_SHAPE__IS_EXPANDED:
				return isIsExpanded();
			case Bpmn2DiPackage.BPMN_SHAPE__IS_HORIZONTAL:
				return isIsHorizontal();
			case Bpmn2DiPackage.BPMN_SHAPE__IS_MARKER_VISIBLE:
				return isIsMarkerVisible();
			case Bpmn2DiPackage.BPMN_SHAPE__IS_MESSAGE_VISIBLE:
				return isIsMessageVisible();
			case Bpmn2DiPackage.BPMN_SHAPE__PARTICIPANT_BAND_KIND:
