 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNLabelImpl#getLabelStyle <em>Label Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BPMNLabelImpl extends LabelImpl implements BPMNLabel {
	...
	protected EClass eStaticClass() {
		return Bpmn2DiPackage.Literals.BPMN_LABEL;
	}
		...
		if (labelStyle != null && labelStyle.eIsProxy()) {
			...
			if (labelStyle != oldLabelStyle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2DiPackage.BPMN_LABEL__LABEL_STYLE, oldLabelStyle, labelStyle));
			}
		}
		return labelStyle;
	}
	...
	public void setLabelStyle(BPMNLabelStyle newLabelStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_LABEL__LABEL_STYLE, oldLabelStyle, labelStyle));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bpmn2DiPackage.BPMN_LABEL__LABEL_STYLE:
