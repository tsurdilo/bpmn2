...
import org.eclipse.dc.impl.DcPackageImpl;

import org.eclipse.di.DiPackage;

import org.eclipse.di.impl.DiPackageImpl;
 ...
 * @generated
 */
public class Bpmn2DiPackageImpl extends EPackageImpl implements Bpmn2DiPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.bpmn2.bpmn2di.Bpmn2DiPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Bpmn2DiPackageImpl() {
		super(eNS_URI, Bpmn2DiFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Bpmn2DiPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Bpmn2DiPackage init() {
		if (isInited) return (Bpmn2DiPackage)EPackage.Registry.INSTANCE.getEPackage(Bpmn2DiPackage.eNS_URI);

		// Obtain or create and register package
		Bpmn2DiPackageImpl theBpmn2DiPackage = (Bpmn2DiPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Bpmn2DiPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Bpmn2DiPackageImpl());
		...
		theBpmn2DiPackage.createPackageContents();
		theDiPackage.createPackageContents();
		theDcPackage.createPackageContents();

		// Initialize created meta-data
		theBpmn2DiPackage.initializePackageContents();
		...
		theBpmn2DiPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Bpmn2DiPackage.eNS_URI, theBpmn2DiPackage);
		return theBpmn2DiPackage;
	}
	 ...
	 * @generated
	 */
	public Bpmn2DiFactory getBpmn2DiFactory() {
		return (Bpmn2DiFactory)getEFactoryInstance();
	}
