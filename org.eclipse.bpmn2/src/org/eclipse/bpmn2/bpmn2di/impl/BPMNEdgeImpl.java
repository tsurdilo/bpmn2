...
import org.eclipse.bpmn2.bpmn2di.MessageVisibleKind;

import org.eclipse.di.DiagramElement;

import org.eclipse.di.impl.LabeledEdgeImpl;
 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNEdgeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNEdgeImpl#getBpmnElement <em>Bpmn Element</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNEdgeImpl#getMessageVisibleKind <em>Message Visible Kind</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNEdgeImpl#getSourceElement <em>Source Element</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNEdgeImpl#getTargetElement <em>Target Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BPMNEdgeImpl extends LabeledEdgeImpl implements BPMNEdge {
	...
	protected EClass eStaticClass() {
		return Bpmn2DiPackage.Literals.BPMN_EDGE;
	}
	...
	public NotificationChain basicSetLabel(BPMNLabel newLabel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_EDGE__LABEL, oldLabel, newLabel);
	...
	public void setLabel(BPMNLabel newLabel) {
		if (newLabel != label) {
			...
			if (label != null)
				msgs = ((InternalEObject)label).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Bpmn2DiPackage.BPMN_EDGE__LABEL, null, msgs);
			if (newLabel != null)
				msgs = ((InternalEObject)newLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Bpmn2DiPackage.BPMN_EDGE__LABEL, null, msgs);
			msgs = basicSetLabel(newLabel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_EDGE__LABEL, newLabel, newLabel));
	}
	...
	public BaseElement getBpmnElement() {
		if (bpmnElement != null && bpmnElement.eIsProxy()) {
			...
			if (bpmnElement != oldBpmnElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2DiPackage.BPMN_EDGE__BPMN_ELEMENT, oldBpmnElement, bpmnElement));
			}
		}
		return bpmnElement;
	}
	...
	public void setBpmnElement(BaseElement newBpmnElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_EDGE__BPMN_ELEMENT, oldBpmnElement, bpmnElement));
	}
	...
	public void setMessageVisibleKind(MessageVisibleKind newMessageVisibleKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_EDGE__MESSAGE_VISIBLE_KIND, oldMessageVisibleKind, messageVisibleKind));
	}
	...
	public DiagramElement getSourceElement() {
		if (sourceElement != null && sourceElement.eIsProxy()) {
			...
			if (sourceElement != oldSourceElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2DiPackage.BPMN_EDGE__SOURCE_ELEMENT, oldSourceElement, sourceElement));
			}
		}
	...
	public void setSourceElement(DiagramElement newSourceElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_EDGE__SOURCE_ELEMENT, oldSourceElement, sourceElement));
	}
	...
	public DiagramElement getTargetElement() {
		if (targetElement != null && targetElement.eIsProxy()) {
			...
			if (targetElement != oldTargetElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2DiPackage.BPMN_EDGE__TARGET_ELEMENT, oldTargetElement, targetElement));
			}
		}
	...
	public void setTargetElement(DiagramElement newTargetElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_EDGE__TARGET_ELEMENT, oldTargetElement, targetElement));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Bpmn2DiPackage.BPMN_EDGE__LABEL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bpmn2DiPackage.BPMN_EDGE__LABEL:
				return getLabel();
			case Bpmn2DiPackage.BPMN_EDGE__BPMN_ELEMENT:
				if (resolve) return getBpmnElement();
				return basicGetBpmnElement();
			case Bpmn2DiPackage.BPMN_EDGE__MESSAGE_VISIBLE_KIND:
				return getMessageVisibleKind();
			case Bpmn2DiPackage.BPMN_EDGE__SOURCE_ELEMENT:
				if (resolve) return getSourceElement();
				return basicGetSourceElement();
			case Bpmn2DiPackage.BPMN_EDGE__TARGET_ELEMENT:
