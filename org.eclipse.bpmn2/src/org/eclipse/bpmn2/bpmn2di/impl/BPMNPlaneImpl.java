...
import org.eclipse.di.impl.PlaneImpl;
 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.bpmn2di.impl.BPMNPlaneImpl#getBpmnElement <em>Bpmn Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BPMNPlaneImpl extends PlaneImpl implements BPMNPlane {
	...
	protected EClass eStaticClass() {
		return Bpmn2DiPackage.Literals.BPMN_PLANE;
	}
		...
		if (bpmnElement != null && bpmnElement.eIsProxy()) {
			...
			if (bpmnElement != oldBpmnElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bpmn2DiPackage.BPMN_PLANE__BPMN_ELEMENT, oldBpmnElement, bpmnElement));
			}
		}
		return bpmnElement;
	}
	...
	public void setBpmnElement(BaseElement newBpmnElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2DiPackage.BPMN_PLANE__BPMN_ELEMENT, oldBpmnElement, bpmnElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bpmn2DiPackage.BPMN_PLANE__BPMN_ELEMENT:
