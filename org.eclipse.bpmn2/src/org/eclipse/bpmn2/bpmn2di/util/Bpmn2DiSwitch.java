...
public class Bpmn2DiSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Bpmn2DiPackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bpmn2DiPackage.BPMN_DIAGRAM: {
			...
			case Bpmn2DiPackage.BPMN_LABEL: {
			...
			case Bpmn2DiPackage.BPMN_LABEL_STYLE: {
			...
			case Bpmn2DiPackage.BPMN_PLANE: {
			...
			case Bpmn2DiPackage.BPMN_SHAPE: {
